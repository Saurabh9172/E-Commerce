...
const LoginSignup = () => {
     ...
     const login= async ()=>{
        console.log("Login Function Executed",formData);
         let responseData;
         await fetch('https://ecommerce-fwczaqa5cwdrfsgc.eastasia-01.azurewebsites.net/login',{
         method:'POST',
         headers:{
     ...
     const signup= async ()=>{
       ...
       let responseData;
       await fetch('https://ecommerce-fwczaqa5cwdrfsgc.eastasia-01.azurewebsites.net/signup',{
        method:'POST',
        headers:{
          Accept:'application/form-data',
          'Content-Type':'application/json'
